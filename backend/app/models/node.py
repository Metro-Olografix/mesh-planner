...
class Node(Base):
    ...
    antenna_gain_dbi = Column(
        Float, nullable=True
    )  # overrides hardware default when set
    sim_radius_km = Column(
        Float, nullable=False, server_default="10", default=10.0
    )  # SPLAT! radius
    ...
    lora_preset = Column(
        String, nullable=False, server_default="MEDIUM_FAST", default="MEDIUM_FAST"
    )
    high_resolution = Column(
